...
{
public:
    IMUManager(const char* portname);
    ~IMUManager();

    const uint16_t CRC16_table[256] = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50A5, 0x60C6, 0x70E7, 0x8108, 0x9129,
...
private:
    ...
    ImuSharedData *imu_data;
    std::vector<uint8_t> buffer;
    int fd;
    size_t loop_count = 0;

    void processIMUFrame(const uint8_t* data, size_t length);
    void imuRS485Thread();
    ImuSharedData getIMUData();
};
